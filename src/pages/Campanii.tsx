      ...
      <section className="mb-10 animate-fade-in-up">
        <Card className="rounded-3xl border-border/60 shadow-lg bg-card overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              >
                <a href={superputeriViewUrl} target="_blank" rel="noopener noreferrer">
                  ...
                  Deschide „Ghidul Campaniei - Superputerile Caracterului”
                </a>
              </Button>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-6 md:p-8 bg-muted/20">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-6 rounded-2xl bg-card border border-border/60 shadow-sm">
              <div className="flex items-center gap-3">
                <FileText className="h-8 w-8 text-primary shrink-0" />
                <div>
                  <h4 className="font-heading font-semibold text-foreground">Ghidul Campaniei „Construim Superputerile Caracterului”</h4>
                  <p className="text-xs text-muted-foreground">Document PDF pe Google Drive</p>
                </div>
              </div>
              <Button asChild variant="default" className="rounded-xl font-semibold gap-2 shrink-0">
                <a href={superputeriViewUrl} target="_blank" rel="noopener noreferrer">
                  <ExternalLink className="h-4 w-4" />
                  Deschide „Ghidul Campaniei”
                </a>
              </Button>
            </div>
          </CardContent>
