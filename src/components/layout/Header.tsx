...
export const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 border-b transition-transform duration-300 ease-out ${
