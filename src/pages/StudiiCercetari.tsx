    ...
    <MainLayout>
      ...
      <section className="mb-10 animate-fade-in-up">
        <Card className="rounded-3xl border-border/60 shadow-lg bg-card overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 p-6 md:p-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              >
                ...
                >
                  ...
                  <span className="break-words">Deschide „Studiul OSP clasele a VIII-a”</span>
                </a>
              </Button>
            </div>
          </CardHeader>
